let last_updated = "Apr 15, 2025 9:54pm"; // <----- UPDATE THIS DATE WHENEVER YOU UPDATE SCORES!!
document.getElementById("lu-date").innerHTML = last_updated;

// paste array of objects containing data
let data = [
  { name: "Caleb Mok", T: 35, A: 26, G: 28, W: 17, L: 19, D: 4, Rating: 482 },
  {
    name: "Charles Torpey",
    T: 12,
    A: 8,
  ...
  { name: "Jake Dapiran", T: 29, A: 6, G: 14, W: 4, L: 22, D: 1, Rating: 50 },
  { name: "Joseph Faso", T: 32, A: 39, G: 16, W: 17, L: 22, D: 4, Rating: 444 },
  { name: "Kevin Camelin", T: 13, A: 3, G: 9, W: 4, L: 6, D: 1, Rating: 434 },
  {
    name: "Joshua Krone",
    T: 27,
    A: 29,
  ...
  { name: "Jakob Lail", T: 52, A: 37, G: 29, W: 20, L: 19, D: 4, Rating: 488 },
  {
    name: "Jacob Linares",
    T: 20,
    A: 17,
  ...
  { name: "Roman Leigh", T: 22, A: 11, G: 14, W: 8, L: 10, D: 0, Rating: 428 },
  {
  ...
  { name: "Tanner Yue", T: 20, A: 18, G: 23, W: 16, L: 16, D: 2, Rating: 552 },
  {
    name: "Tadeas Horn",
    T: 28,
    A: 49,
  ...
  { name: "Vincent Cook", T: 35, A: 12, G: 15, W: 9, L: 21, D: 4, Rating: 174 },
  { name: "Xavier Herrera", T: 17, A: 7, G: 7, W: 5, L: 7, D: 4, Rating: 430 },
];
