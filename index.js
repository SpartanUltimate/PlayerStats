let last_updated = "Mar 21, 2025 12:04am"; // <----- UPDATE THIS DATE WHENEVER YOU UPDATE SCORES!!
document.getElementById("lu-date").innerHTML = last_updated;

// paste array of objects containing data
let data = [
  { name: "Caleb Mok", T: 25, A: 16, G: 22, W: 12, L: 16, D: 3, Rating: 434 },
  { name: "Charles Torpey", T: 4, A: 2, G: 6, W: 4, L: 5, D: 5, Rating: 508 },
  {
  ...
  { name: "Dan Thompson", T: 17, A: 6, G: 11, W: 7, L: 17, D: 5, Rating: 286 },
  { name: "Edwin Lu", T: 18, A: 6, G: 6, W: 6, L: 9, D: 2, Rating: 388 },
  {
  ...
  { name: "Jake Dapiran", T: 25, A: 4, G: 10, W: 2, L: 17, D: 1, Rating: 110 },
  { name: "Joseph Faso", T: 25, A: 22, G: 10, W: 12, L: 12, D: 4, Rating: 494 },
  ...
  { name: "Jakob Lail", T: 29, A: 20, G: 14, W: 9, L: 13, D: 1, Rating: 386 },
  {
    name: "Jacob Linares",
    T: 13,
    A: 12,
  ...
  { name: "Tanner Yue", T: 16, A: 7, G: 13, W: 8, L: 12, D: 2, Rating: 412 },
  { name: "Tadeas Horn", T: 17, A: 35, G: 18, W: 21, L: 9, D: 7, Rating: 878 },
  { name: "Vincent Cook", T: 28, A: 9, G: 12, W: 6, L: 17, D: 2, Rating: 204 },
  { name: "Xavier Herrera", T: 3, A: 0, G: 1, W: 1, L: 2, D: 1, Rating: 470 },
];
